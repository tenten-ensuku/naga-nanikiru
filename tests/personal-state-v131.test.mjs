...
test("V137 separates range selection from favorite and archive filters", async () => {
  const html = await readFile(htmlUrl, "utf8");
...
test("V137 keeps archive as an independent view while range remains numeric", async () => {
  const html = await readFile(htmlUrl, "utf8");
