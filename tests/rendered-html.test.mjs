...
test("wires v48 learning UX, generator, Supabase bridge, metadata, and social image", async () => {
  ...
  assert.match(index, /const APP_VERSION = 48/);
  assert.match(index, /supabase-sync-v47\.js/);
