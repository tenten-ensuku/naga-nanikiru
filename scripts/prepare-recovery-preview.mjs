...
export function recoveryPublication(html, setting='') {
  ...
  if (!/const APP_VERSION = (230|231|232|233|234|235|236|237|238|239|240|241|242|243|244|245|246|247|248|249|250|251);/.test(html) || (html.match(/window\.NAGA_MAINTENANCE_MODE = false;/g)||[]).length!==1) {
    throw new Error('Expected the reviewed V230-V251 source');
  }
  return setting==='true'
