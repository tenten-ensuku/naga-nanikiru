...
export function recoveryPublication(html, setting='') {
  ...
  if (!/const APP_VERSION = 230;/.test(html) || (html.match(/window\.NAGA_MAINTENANCE_MODE = false;/g)||[]).length!==1) {
    throw new Error('Expected the reviewed V230 restoration source');
  }
  return setting==='true'
